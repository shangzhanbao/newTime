...
public class UpdateVisitNumAction extends StrutsAction{
	
	private String axisId;
	
	public void updateVisitNum() throws IOException {
		...
		if (axisId.equals("") || axisId == null) {
			...
			ServiceContext.get(AxisService.class).updateVisitNum(axisId);
